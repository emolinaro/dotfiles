...
Apt handles system packages, Home Manager owns user config, and bootstrap auto-selects `x86_64`/`arm64`, enables Docker and `/usr/bin/zsh`, then prompts `codex login` after restart.
